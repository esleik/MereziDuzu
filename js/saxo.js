$(document).ready(function () {
  ...
  function cargarYMostrarInstrumentos(archivoJSON, contenedorID) {
    $.ajax({
      ...
      success: function (json) {
        mostrarInstrumentos(json.saxos, contenedorID);
      },
  ...
  function filtrarInstrumentosPorMarca(marca, contenedorID) {
    ...
    cargarYMostrarInstrumentos('saxos.json', contenedorID); // Recargar y mostrar los instrumentos
  }
