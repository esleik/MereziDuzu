$(document).ready(function () {
  ...
  function cargarYMostrarInstrumentos(archivoJSON, contenedorID) {
    $.ajax({
      ...
      success: function (json) {
        mostrarInstrumentos(json.pianos, contenedorID);
      },
  ...
  function filtrarInstrumentosPorMarca(marca, contenedorID) {
    ...
    cargarYMostrarInstrumentos('pianos.json', contenedorID); // Recargar y mostrar los instrumentos
  }
