$(document).ready(function () {
  ...
  function cargarYMostrarInstrumentos(archivoJSON, contenedorID) {
    $.ajax({
      ...
      success: function (json) {
        mostrarInstrumentos(json.percusion, contenedorID);
      },
  ...
  function filtrarInstrumentosPorMarca(marca, contenedorID) {
    ...
    cargarYMostrarInstrumentos('percusion.json', contenedorID); // Recargar y mostrar los instrumentos
  }
