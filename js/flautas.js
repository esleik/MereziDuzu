$(document).ready(function () {
  ...
  function cargarYMostrarInstrumentos(archivoJSON, contenedorID) {
    $.ajax({
      ...
      success: function (json) {
        mostrarInstrumentos(json.flautas, contenedorID);
      },
  ...
  function filtrarInstrumentosPorMarca(marca, contenedorID) {
    ...
    cargarYMostrarInstrumentos('flautas.json', contenedorID); // Recargar y mostrar los instrumentos
  }
